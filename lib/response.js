...
module.exports = {
   ...
   *
   * This differs from checking `this.body`, as it must distinguish
   * between an unset body (`undefined`) and an explicitly null body.
   *
   * @return {Boolean}
   * @api public
   */
  ...
  get hasBody () {
    if (this._explicitNullBody) return false
  ...
  set body (val) {
    ...
    const explicitNull = (val === null)
    this._body = val

    this._explicitNullBody = explicitNull
